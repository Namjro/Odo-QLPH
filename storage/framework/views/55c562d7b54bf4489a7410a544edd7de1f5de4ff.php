...
<!--                <button type="button" class="btn btn-default">Default</button>-->
                <a href="<?php echo e(url('config/role/create')); ?>" class="btn btn-primary"><?php echo e(__("create")); ?></a>
    ...
    <div class="col-sm-12">
        <section class="panel">
            <header class="panel-heading">
                <?php echo e(__("list")); ?> <?php echo e(__("roles")); ?>
            ...
            <div class="panel-body">
                <div class="row">
                    <div id="tuananh" class="col-sm-4">
                        <form action="<?php echo e(url('config/role/search')); ?>">
                    ...
                    <table class="table table-bordered table-striped table-condensed">
                        ...
                        <?php foreach($records as $record){ ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-xs btn-primary" href="<?php echo e(url('config/role/edit',['id'=>$record->id])); ?>"><?php echo e(__("edit")); ?></a>
                                    <a class="delete btn btn-xs btn-danger" href="<?php echo e(url('config/role/delete',['id'=>$record->id])); ?>"><?php echo e(__("delete")); ?></a>
                                </td>
                            </tr>
                        <?php } ?>

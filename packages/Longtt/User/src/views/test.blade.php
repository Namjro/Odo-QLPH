...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo getUrl('/'); ?>/BucketAdmin/html/images//favicon.png">
    <title>BucketAdmin</title>
    <!--Core CSS -->
    <link href="<?php echo getUrl('/'); ?>/BucketAdmin/html/bs3/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo getUrl('/'); ?>/BucketAdmin/html/js/jquery-ui/jquery-ui-1.10.1.custom.min.css" rel="stylesheet">
    ...
    <link href="<?php echo getUrl('/'); ?>/BucketAdmin/html/js/jvector-map/jquery-jvectormap-1.2.2.css" rel="stylesheet">
    <link href="<?php echo getUrl('/'); ?>/BucketAdmin/html/css/clndr.css" rel="stylesheet">
    <!--clock css-->
    <link href="<?php echo getUrl('/'); ?>/BucketAdmin/html/js/css3clock/css/style.css" rel="stylesheet">
    <!--Morris Chart CSS -->
    <link rel="stylesheet" href="<?php echo getUrl('/'); ?>/BucketAdmin/html/js/morris-chart/morris.css">
    ...
    <ul class="nav top-menu">
        ...
        <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="<?php echo getUrl('/'); ?>/BucketAdmin/html/images//avatar-mini.jpg"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="<?php echo getUrl('/'); ?>/BucketAdmin/html/images//avatar-mini-2.jpg"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="<?php echo getUrl('/'); ?>/BucketAdmin/html/images//avatar-mini-3.jpg"></span>
                                <span class="subject">
                    ...
                    <ul class="conversation-list">
                        <li class="clearfix">
                            <div class="chat-avatar">
                                <img src="<?php echo getUrl('/'); ?>/BucketAdmin/html/images//chat-user-thumb.png" alt="male">
                                <i>10:00</i>
                            </div>
                        ...
                        <li class="clearfix odd">
                            <div class="chat-avatar">
                                <img src="<?php echo getUrl('/'); ?>/BucketAdmin/html/images//chat-user-thumb-f.png" alt="female">
                                <i>10:00</i>
                            </div>
                            <div class="conversation-text">
                                <div class="ctext-wrap">
...
<div class="row">
    <div class="col-md-8">
        <section class="panel">
            <div class="wdgt-row">
                <img src="<?php echo getUrl('/'); ?>/BucketAdmin/html/images//weather_image.jpg" height="243" alt="">
                <div class="wdt-head">
                    weather forecast
                </div>
        ...
        <li>
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="<?php echo getUrl('/'); ?>/BucketAdmin/html/images//avatar1_small.jpg" alt=""></a>
                </div>
            ...
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="<?php echo getUrl('/'); ?>/BucketAdmin/html/images//avatar1.jpg" alt=""></a>
                </div>
                <div class="user-details">
            ...
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="<?php echo getUrl('/'); ?>/BucketAdmin/html/images//chat-avatar2.jpg" alt=""></a>
                </div>
                <div class="user-details">
...
<!-- Placed <?php echo getUrl('/'); ?>/BucketAdmin/html/<?php echo getUrl('/'); ?>/BucketAdmin/html/js/ at the end of the document so the pages load faster -->
<!--Core js-->
<script src="<?php echo getUrl('/'); ?>/BucketAdmin/html/js/jquery.js"></script>
<script src="<?php echo getUrl('/'); ?>/BucketAdmin/html/js/jquery-ui/jquery-ui-1.10.1.custom.min.js"></script>
<script src="<?php echo getUrl('/'); ?>/BucketAdmin/html/bs3/js/bootstrap.min.js"></script>
<script src="<?php echo getUrl('/'); ?>/BucketAdmin/html/js/jquery.dcjqaccordion.2.7.js"></script>
...
<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="<?php echo getUrl('/'); ?>/BucketAdmin/html/js/flot-chart/excanvas.min.js"></script><![endif]-->
<script src="<?php echo getUrl('/'); ?>/BucketAdmin/html/js/skycons/skycons.js"></script>
<script src="<?php echo getUrl('/'); ?>/BucketAdmin/html/js/jquery.scrollTo/jquery.scrollTo.js"></script>
<script src="//cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js"></script>
<script src="<?php echo getUrl('/'); ?>/BucketAdmin/html/js/calendar/clndr.js"></script>
<script src="http://cdnjs.cloudflare.com/ajax/libs/underscore.js/1.5.2/underscore-min.js"></script>
<script src="<?php echo getUrl('/'); ?>/BucketAdmin/html/js/calendar/moment-2.2.1.js"></script>
<script src="<?php echo getUrl('/'); ?>/BucketAdmin/html/js/evnt.calendar.init.js"></script>
<script src="<?php echo getUrl('/'); ?>/BucketAdmin/html/js/jvector-map/jquery-jvectormap-1.2.2.min.js"></script>
<script src="<?php echo getUrl('/'); ?>/BucketAdmin/html/js/jvector-map/jquery-jvectormap-us-lcc-en.js"></script>
<script src="<?php echo getUrl('/'); ?>/BucketAdmin/html/js/gauge/gauge.js"></script>
<!--clock init-->
<script src="<?php echo getUrl('/'); ?>/BucketAdmin/html/js/css3clock/js/css3clock.js"></script>
<!--Easy Pie Chart-->
...
<!--Morris Chart-->
<script src="<?php echo getUrl('/'); ?>/BucketAdmin/html/js/morris-chart/morris.js"></script>
<script src="<?php echo getUrl('/'); ?>/BucketAdmin/html/js/morris-chart/raphael-min.js"></script>
<!--jQuery Flot Chart-->
...
<script src="<?php echo getUrl('/'); ?>/BucketAdmin/html/js/flot-chart/jquery.flot.animator.min.js"></script>
<script src="<?php echo getUrl('/'); ?>/BucketAdmin/html/js/flot-chart/jquery.flot.growraf.js"></script>
<script src="<?php echo getUrl('/'); ?>/BucketAdmin/html/js/dashboard.js"></script>
<script src="<?php echo getUrl('/'); ?>/BucketAdmin/html/js/jquery.customSelect.min.js" ></script>

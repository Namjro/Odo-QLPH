    ...
    <div class="col-sm-12">
        <section class="panel">
            <div class="panel-body">
                ...
                <a href="{{url('user/create_npp')}}" class="btn btn-primary">Thêm mới Nhà phân phối</a>
                ...
                <section id="unseen">
                    <table class="table table-bordered table-striped table-condensed">
                        ...
                        <tr>
                            ...
                            <th>password</th>
                            <th>facebook_id</th>
                            <th>facebook_token</th>
                            <th>facebook_token_expire_time</th>
                            <th>avatar</th>
                        ...
                        <?php foreach ($records as $record) { ?>
                            <tr>
                                ...
                                <td>{{$record->facebook_id}}</td>
                                <td>{{$record->facebook_token}}</td>
                                <td>{{$record->facebook_token_expire_time}}</td>
                                <td>{{$record->avatar}}</td>
